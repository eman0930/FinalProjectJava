...
class FrameTest
{
	private GamesFrame testedFrame;

	@BeforeEach
	void setUp() throws Exception
	{
		this.testedFrame = new GamesFrame(new Controller()); 
	}
	...
	void testPokeFrame()
	{
		...
		assertTrue(testedFrame.getContentPane() instanceof GamesPanel, "Your PokeFrame needs to have a PokePanel inside");
	}
}
